...
setEPS()
postscript(file="/Users/Battrd/Documents/School&Work/WiscResearch/Isotopes_2012Analysis/Figures/Chl_DO_pCO2_NEP_PaulWard_2010&2012_ForESA.eps", width=5, height=4.5, pointsize=10)
par(mfrow=c(2,2), mar=c(2,4,1.5,1), oma=c(1, 0, 0, 0), ps=10, cex=1)
