...
# ======================================
load("/Users/Battrd/Documents/School&Work/WiscResearch/Isotopes_2012Analysis/Figures/Figures_v0.4.0_ModelSelection/ResourceUse2010&2012_v0.4.0_ModelSelection.RData")
...
rm(list=(ls()[!is.element(ls(), c("sensit", "sensit2"))]))
# =================================
# = End Sensitivity Analysis Data =
# =================================d

setwd("/Users/battrd/Documents/School&Work/WiscResearch/Isotopes_2012Analysis")
load("Cons_Mixture_Ward2010&2012_v0.4.9.RData")
FigureFolder <- paste("Figures/Figures_", "v0.4.9", sep="")
