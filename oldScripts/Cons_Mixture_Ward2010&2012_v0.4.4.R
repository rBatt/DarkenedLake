...
for(i in 1:length(Cons)){
	...
	AllRU[[Cons[i]]] <- aggregate(ThisRU[,"Proportion"], by=list("Source"=ThisRU[,"Source"], "Year"=ThisRU[,"Year"], "Consumer"=ThisRU[,"Consumer"]), FUN=mean)
...
save.image("Cons_Mixture_Ward2010&2012_v0.4.4.RData")
