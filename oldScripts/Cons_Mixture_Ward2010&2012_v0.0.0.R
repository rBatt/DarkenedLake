...
YearMix <- 2012 #The year to use for consumers, POM, DOM, Water, Periphyton (everything except for terrestrial and macrophytes)
Iterations <- 1000
...
if(YearMix==2010){
	TSources <- c("Alder", "Sedge")#, "Tamarack") #c("Alder", "Sedge", "DOM")
}else{
...
SourceNames <- list(c("Terrestrial", "Pelagic Epilimnion", "Pelagic Metalimnion", "DOM"), c("Terrestrial", "Pelagic", "Benthic", "Littoral"))
