...
#Version 0.4.6 (13-Aug-2013): I am increasing the trophic level of the mud minnow to see if its resource use falls in line with the fishes fishes if I do this.
...
for(YearMix in c(2010, 2012)){
	...
	if(YearMix==2010){
		...
		TL <- c("Calanoid"=1,"Mesocyclops"=1, "Chaoborus"=2, "Helisoma trivolvis"=1, "FHM"=2, "DAC"=2, "CMM"=3, "BHD1"=2, "BHD2"=3, "PKS"=2, "YWP"=3)[ConsChoose] # CHANGED 0.4.6
		...
		Cons <- c("Calanoid"="Calanoid", "Mesocyclops"="Mesocyclops", "Chaoborus"="Chaoborus", "Helisoma trivolvis"="Helisoma trivolvis", "FHM"="FHM", "DAC"="DAC", "CMM"="CMM", "BHD1"="BHD1", "BHD2"="BHD2", "PKS"="PKS", "YWP"="YWP")[ConsChoose]
		TL <- c("Calanoid"=1,"Mesocyclops"=1, "Chaoborus"=2, "Helisoma trivolvis"=1, "FHM"=2, "DAC"=2, "CMM"=3, "BHD1"=2, "BHD2"=3, "PKS"=2, "YWP"=3)[ConsChoose]
		GraphTitle <- c("Calanoid"="Skistodiaptomus oregonensis", "Mesocyclops"="Mesocyclops spp.", "Chaoborus spp.", "Helisoma trivolvis"="Helisoma trivolvis", "FHM"="Pimephales promelas", "DAC"="Phoxinus spp.", "CMM"="Umbra limi", "BHD1"="Small Ameiurus melas", "BHD2"="Large Ameiurus melas", "PKS"="Lepomis gibbosus", "YWP"="Perca flavescens")[ConsChoose]
	}
...
if(Save){
	if(SaveType==".pdf"){pdf(file=paste(paste("NeatSummary_", Version, sep=""), ".pdf", sep=""), height=7, width=6.811, pointsize=10)}
	if(SaveType==".png"){png(file=paste(paste("NeatSummary_", Version, sep=""), ".png", sep=""), units="in", res=200, height=7, width=6.811, pointsize=10)}
	if(SaveType==".eps"){setEPS();postscript(file=paste(paste("NeatSummary_", Version, sep=""), ".eps", sep=""), height=7, width=6.811, pointsize=10)}
}else{
...
save.image("Cons_Mixture_Ward2010&2012_v0.4.6.RData")
