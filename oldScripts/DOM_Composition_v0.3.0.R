...
#1) 105 mg (in 2012 there was 10.65mg C, and C was 10%, and there was 1.5 mg C from Aquashade, so (10.65/0.1)-1.5=105)
#2) 9.35% C (9.96 mg)	#(0.1 - .46*(1.5/106.5))*100 #to get the percent DOM (sans aquashade) that is carbon
#3) 0.28% N (0.2985 mg)	#(0.004 - .085*(1.5/106.5))*100 #to get the percent DOM (sans aquashade) that is nitrogen
#4) 2.18% H (2.322 mg)	#(0.023 - .085*(1.5/106.5))*100 #to get the percent DOM (sans aquashade) that is hydrogen
