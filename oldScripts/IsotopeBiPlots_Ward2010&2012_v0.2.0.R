...
# Data <- subset(Data, Trophic>=0 & SampleID!="O-0362" & Taxon!="POC" & Taxon!="DOC", select=c("Trophic","Taxon","d13C","d15N","dD"))


Data <- droplevels(subset(Data, Trophic>=0 & !is.element(SampleID, c("O-0362", "V-0270", "P-1202", "P-1166", "O-0382", "P-1165", "P-1206", "P-1238", "P-1239", "P-1243", "Z-1110", "Z-1115", "Z-1195", "Z-1170", "O-0405")) & Taxon!="POM" & Taxon!="Nija" & Taxon!="YWP", select=c("Year","Trophic","Taxon","d13C","d15N","dD")))
...
pdf(file=paste(FigureFolder,"/Ward2010&2012_IsoBiPlot_",ThisVersion,".pdf",sep=""), width=5.25, height=5.25, pointsize=9)
