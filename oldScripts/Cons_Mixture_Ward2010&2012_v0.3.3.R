...
for(YearMix in c(2010, 2012)){
	...
	ConsChoices <- list(
					"Calanoid"=list(c("All Terrestrial", "Epi. Phytoplankton", "Meta. Phytoplankton", "All Macrophytes") , c("All Terrestrial", "All Phytoplankton", "Periphyton",  "Submersed Macrophytes")),
					"Chaoborus"=list(c("All Terrestrial", "Epi. Phytoplankton", "Meta. Phytoplankton", "All Macrophytes") , c("All Terrestrial", "All Phytoplankton", "Periphyton",  "Submersed Macrophytes")),
...
save(list=c("ResourceUse", "DOM_Comp"), file=paste("ResourceUse2010&2012_", Version, ".RData",sep=""))


aggregate(ResourceUse[,5:8], by=list(ResourceUse[,1], ResourceUse[,3], ResourceUse[,4]), FUN=median)