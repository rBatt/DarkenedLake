...
#Version 0.3.0 (03-Feb-2013): I am changing the diet for the zoops.  Grouping the algae together, maybe adding some macrophytes.
...
for(YearMix in c(2010, 2012)){
	...
	ConsChoices <- list(
					"Calanoid"=list(c("All Terrestrial", "Epi. Phytoplankton", "Periphyton", "DOM") , c("All Terrestrial", "All Phytoplankton", "Floating Macrophytes",  "Submersed Macrophytes")),
					"Chaoborus"=list(c("All Terrestrial", "Epi. Phytoplankton", "Meta. Phytoplankton", "DOM") , c("All Terrestrial", "All Phytoplankton", "Floating Macrophytes",  "Submersed Macrophytes")),
