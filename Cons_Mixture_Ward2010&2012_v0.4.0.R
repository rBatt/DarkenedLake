...
for(YearMix in c(2010, 2012)){
	...
	ConsChoices <- list(
					...
					"Helisoma trivolvis"=list(c("All Terrestrial", "Floating Macrophytes", "Submersed Macrophytes", "Periphyton")),
					...
					"CMM"=list(c("All Terrestrial", "All Phytoplankton", "Floating Macrophytes", "Periphyton")),
					"BHD1"=list(c("All Terrestrial", "All Phytoplankton", "Floating Macrophytes", "Periphyton")),
					"BHD2"=list(c("All Terrestrial", "All Phytoplankton", "Floating Macrophytes", "Periphyton"))
					)
